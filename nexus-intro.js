...
(function () {
    ...
    function _buildOverlay() {
        ...
        el.innerHTML =
            ...
            // Title — official Shadow Nexus Social logo image
            '<div id="snxIntroTitle">' +
            '<div class="snxi-welcome-to">Welcome to</div>' +
            '<picture class="snxi-logo-picture">' +
            '<source srcset="assets/images/shadow-nexus-social-logo.webp" type="image/webp">' +
            '<img id="snxiLogoImg" class="snxi-logo-img" src="assets/images/shadow-nexus-social-logo.png" alt="Shadow Nexus Social" draggable="false">' +
            '</picture>' +
